...
<i class="fas fa-building text-gray-500 group-hover:text-gray-600 w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 shadow-sm rounded p-0.5 bg-white/50 transition-all duration-300"></i>           <span class="font-semibold tracking-wide flex-1 min-w-0 truncate text-dark-800">Offices</span>
        </a>
        ...
        <a href="view_user.php" 
           ...
           <span class="font-semibold tracking-wide flex-1 min-w-0 truncate text-blue-800">Employees</span>
        </a>
