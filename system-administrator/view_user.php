...
<div class="w-3/4 p-1 h-[calc(79vh-2rem)]">
        ...
        WHERE user_status != 'Archived'";
          ...
          ?>
            <tr class="border-b hover:bg-gray-50">
              <td class="px-4 py-2"><?php echo htmlspecialchars($rs['name']); ?></td>
              <td class="px-4 py-2"><?php echo htmlspecialchars($rs['email_address']); ?></td>
  ...
  <div class="relative inline-flex justify-center">
    ...
    <div id="menu<?php echo $rs['id']; ?>" 
      ...
      <!-- ARCHIVE -->
      <button onclick="confirmArchiveAdmin(<?php echo $rs['id']; ?>); closeMenu(<?php echo $rs['id']; ?>)"
