...
<div class="mt-24 px-6 flex gap-6">
 ...
 class="flex items-center gap-3 w-full px-4 py-3 rounded-2xl
  ...
  <span class="font-medium text-gray-500 truncate"> Records Administrators</span>
</a>
...
<a href="system-administrator.php"
 class="flex items-center gap-3 w-full px-4 py-3 rounded-2xl
  ...
  <i class="fas fa-server text-indigo-500 w-4 h-4"></i>
  <span class="font-medium indigo-gray-500 truncate"> System Administrators</span>
</a>
