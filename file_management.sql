...
--
-- Table structure for table `admin_Log in`
--

CREATE TABLE `admin_Log in` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
...
--
-- Dumping data for table `admin_Log in`
--

INSERT INTO `admin_Log in` (`id`, `name`, `admin_user`, `admin_password`, `admin_status`) VALUES
...
CREATE TABLE `history_log` (
  ...
  `ip` text NOT NULL,
  `host` text NOT NULL,
  `Log in_time` varchar(200) NOT NULL,
...
INSERT INTO `history_log` (`log_id`, `id`, `email_address`, `action`, `actions`, `ip`, `host`, `Log in_time`, `logout_time`) VALUES
...
INSERT INTO `history_log1` (`log_id`, `id`, `admin_user`, `action`, `actions`, `ip`, `host`, `Log in_time`, `logout_time`) VALUES
...
--
-- Table structure for table `Log in_user`
--

CREATE TABLE `Log in_user` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
  `email_address` text NOT NULL,
...
--
-- Dumping data for table `Log in_user`
--

INSERT INTO `Log in_user` (`id`, `name`, `email_address`, `user_password`, `user_status`) VALUES
...
--
-- Indexes for table `admin_Log in`
--
ALTER TABLE `admin_Log in`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `Log in_user`
--
ALTER TABLE `Log in_user`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admin_Log in`
--
ALTER TABLE `admin_Log in`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `Log in_user`
--
ALTER TABLE `Log in_user`
