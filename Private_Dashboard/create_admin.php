<?php
 ...
 require_once("include/connection.php");
   ...
   if(isset($_POST['reg'])){
	...
	$q_checkadmin = $conn->query("SELECT * FROM `admin_Log in` WHERE `admin_user` = '$user_email'") or die(mysqli_error());
		...
		if($v_checkadmin == 1){
			...
			$conn->query("INSERT INTO `admin_Log in` VALUES('','$user_name', '$user_email', '$user_password', '$user_status')") or die(mysqli_error());
			echo '
				<script type = "text/javascript">
