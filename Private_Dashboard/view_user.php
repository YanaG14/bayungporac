...
$q = mysqli_query($conn,"select * from Log in_user where id = '$id'") or die (mysqli_error($conn));
...
?>
 ...
 if(isset($_POST['edit'])){
     ...
     mysqli_query($conn,"UPDATE `Log in_user` SET `name` = '$user_name', `email_address` = '$email_address', `user_password` = '$user_password' where id='$id'") or die (mysqli_error($conn));
